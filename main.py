...
class Text:
    def __init__(self, text, pos, **options):
        self.text = text
        self.pos = pos
        self.fontname = 'assets/text/Monaco.ttf'
        self.fontsize = 15
...
class App:
    def __init__(self):
        ...
        pygame.display.set_icon(pygame.image.load('assets/images/img.jpeg'))
        flags = RESIZABLE
        ...
        # Make buttons
        App.capture = Button((500, 10), (130, 65), 'assets/images/video.png', (0, 255, 0), (0, 200, 0))
        App.speak = Button((500, 85), (130, 65), 'assets/images/audio.png', (200, 200, 255), (150, 150, 200))
        App.copy = Button((500, 160), (130, 65), 'assets/images/copy.png', (200, 200, 200), (150, 150, 150))
        App.edit = Button((500, 235), (130, 65), 'assets/images/edit.png', (100, 100, 255), (50, 50, 255))
        App.quit = Button((500, 310), (130, 65), 'assets/images/quit.png', (255, 0, 0), (200, 0, 0))
        # Default settings
    ...
    def displayEdit():
        ...
        for i in App.promptArray:
            # Makes the text wrap around
            index += 1
            Text(i, pos = (20, 50 + index * 20)).draw()
        if App.deleteSpeed < 5:
            # Makes sure deleting is not too fast
            App.deleteSpeed = 5
    ...
    def record():
        # Captures a photo from the given camera
    ...
    def summarize():
        # Use gemini model to generate text
        ret, frame = video.read()
        frame_rgb = cv2.cvtColor(frame, cv2.COLOR_BGR2RGB)
        image = PIL.Image.fromarray(frame_rgb)
    ...
    def read(words):
        # Reads the text out loud using gTTS
